...
// System-wide fallback secondary PIN hash for admin/financial approvals (Configurable via ADMIN_SECURITY_PIN env variable)
export const DEFAULT_SYSTEM_ADMIN_PIN_HASH = hashAdminPin(
  process.env.ADMIN_SECURITY_PIN || randomBytes(16).toString('hex')
);
