...
export const SEED_CATEGORIES: Category[] = [
  { id: 'cat_processors', name: 'Processors (CPUs)', slug: 'processors', description: 'High-performance desktop, workstation, and server CPUs from Intel and AMD', icon: 'Cpu', order: 1, isActive: true, productCount: 8 },
  { id: 'cat_gpus', name: 'Graphics Cards (GPUs)', slug: 'gpus', description: 'Discrete desktop and AI workstation accelerators from NVIDIA and AMD', icon: 'Zap', order: 2, isActive: true, productCount: 6 },
  { id: 'cat_motherboards', name: 'Motherboards', slug: 'motherboards', description: 'Enthusiast and workstation motherboards across LGA1700, LGA1851, and AM5', icon: 'Cpu', order: 3, isActive: true, productCount: 5 },
  { id: 'cat_ram', name: 'Memory (RAM)', slug: 'ram', description: 'High-speed DDR5, DDR4, and ECC Registered server memory kits', icon: 'Database', order: 4, isActive: true, productCount: 6 },
  { id: 'cat_storage', name: 'Storage (NVMe/SSD/HDD)', slug: 'storage', description: 'High-speed PCIe Gen5 NVMe SSDs, Enterprise SAS drives, and U.2/U.3 drives', icon: 'HardDrive', order: 5, isActive: true, productCount: 7 },
  { id: 'cat_psus', name: 'Power Supplies (PSUs)', slug: 'power-supplies', description: 'ATX 3.0, PCIe 5.0 80 Plus Gold, Platinum, and Titanium power supplies', icon: 'Zap', order: 6, isActive: true, productCount: 4 },
  { id: 'cat_servers', name: 'Enterprise Rackmount Servers', slug: 'servers', description: '1U/2U/4U Rack servers, Dual Xeon/EPYC compute nodes, and SAN/NAS storage', icon: 'Server', order: 7, isActive: true, productCount: 5 },
  { id: 'cat_laptops', name: 'Laptops & Workstations', slug: 'laptops', description: 'Mobile workstations, ultrabooks, and high-performance gaming laptops', icon: 'Laptop', order: 8, isActive: true, productCount: 6 },
  { id: 'cat_desktops', name: 'All-in-One Desktops', slug: 'desktops', description: 'Pre-built precision workstations and all-in-one desktop computing systems', icon: 'Monitor', order: 9, isActive: true, productCount: 4 },
  { id: 'cat_networking', name: 'Enterprise Networking', slug: 'networking', description: '10GbE/100GbE managed switches, enterprise routers, and firewalls', icon: 'Network', order: 10, isActive: true, productCount: 5 },
  { id: 'cat_monitors', name: 'Monitors & Displays', slug: 'monitors', description: 'Color-calibrated 4K UHD, 5K2K, OLED, and ultrawide enterprise displays', icon: 'Monitor', order: 11, isActive: true, productCount: 4 },
  { id: 'cat_components', name: 'PC Components & Hardware', slug: 'components', description: 'Comprehensive computer components, cooling, cases, and expansion kits', icon: 'Cpu', order: 12, isActive: true, productCount: 12 },
  { id: 'cat_accessories', name: 'Accessories & Peripherals', slug: 'accessories', description: 'Mechanical keyboards, precision mice, docks, and enterprise accessories', icon: 'Keyboard', order: 13, isActive: true, productCount: 6 },
];

export const SEED_BRANDS: Brand[] = [
  { id: 'brand_asus', name: 'ASUS', slug: 'asus', logo: 'https://images.unsplash.com/photo-1591799264318-7e6ef8ddb7ea?auto=format&fit=crop&w=200&q=80', isActive: true, productCount: 8 },
  { id: 'brand_intel', name: 'Intel', slug: 'intel', logo: 'https://images.unsplash.com/photo-1591799264318-7e6ef8ddb7ea?auto=format&fit=crop&w=200&q=80', isActive: true, productCount: 6 },
  { id: 'brand_amd', name: 'AMD', slug: 'amd', logo: 'https://images.unsplash.com/photo-1591799264318-7e6ef8ddb7ea?auto=format&fit=crop&w=200&q=80', isActive: true, productCount: 6 },
  { id: 'brand_nvidia', name: 'NVIDIA', slug: 'nvidia', logo: 'https://images.unsplash.com/photo-1587202372775-e229f172b9d7?auto=format&fit=crop&w=200&q=80', isActive: true, productCount: 5 },
  { id: 'brand_dell', name: 'Dell Technologies', slug: 'dell', logo: 'https://images.unsplash.com/photo-1588872657578-7efd1f1555ed?auto=format&fit=crop&w=200&q=80', isActive: true, productCount: 5 },
  { id: 'brand_corsair', name: 'Corsair', slug: 'corsair', logo: 'https://images.unsplash.com/photo-1587202372775-e229f172b9d7?auto=format&fit=crop&w=200&q=80', isActive: true, productCount: 5 },
  { id: 'brand_samsung', name: 'Samsung Semiconductor', slug: 'samsung', logo: 'https://images.unsplash.com/photo-1597872200969-2b65d56bd16b?auto=format&fit=crop&w=200&q=80', isActive: true, productCount: 5 },
  { id: 'brand_cisco', name: 'Cisco Systems', slug: 'cisco', logo: 'https://images.unsplash.com/photo-1544197150-b99a580bb7a8?auto=format&fit=crop&w=200&q=80', isActive: true, productCount: 4 },
  { id: 'brand_lenovo', name: 'Lenovo', slug: 'lenovo', logo: 'https://images.unsplash.com/photo-1588872657578-7efd1f1555ed?auto=format&fit=crop&w=200&q=80', isActive: true, productCount: 4 },
  { id: 'brand_msi', name: 'MSI', slug: 'msi', logo: 'https://images.unsplash.com/photo-1587202372775-e229f172b9d7?auto=format&fit=crop&w=200&q=80', isActive: true, productCount: 4 },
  { id: 'brand_gigabyte', name: 'Gigabyte', slug: 'gigabyte', logo: 'https://images.unsplash.com/photo-1587202372775-e229f172b9d7?auto=format&fit=crop&w=200&q=80', isActive: true, productCount: 4 },
  { id: 'brand_acer', name: 'Acer', slug: 'acer', logo: 'https://images.unsplash.com/photo-1588872657578-7efd1f1555ed?auto=format&fit=crop&w=200&q=80', isActive: true, productCount: 3 },
  { id: 'brand_apple', name: 'Apple', slug: 'apple', logo: 'https://images.unsplash.com/photo-1517336714731-489689fd1ca8?auto=format&fit=crop&w=200&q=80', isActive: true, productCount: 4 },
  { id: 'brand_evga', name: 'EVGA', slug: 'evga', logo: 'https://images.unsplash.com/photo-1587202372775-e229f172b9d7?auto=format&fit=crop&w=200&q=80', isActive: true, productCount: 3 },
  { id: 'brand_hp', name: 'HP Enterprise', slug: 'hp-enterprise', logo: 'https://images.unsplash.com/photo-1588872657578-7efd1f1555ed?auto=format&fit=crop&w=200&q=80', isActive: true, productCount: 4 },
  { id: 'brand_kingston', name: 'Kingston', slug: 'kingston', logo: 'https://images.unsplash.com/photo-1597872200969-2b65d56bd16b?auto=format&fit=crop&w=200&q=80', isActive: true, productCount: 4 },
  { id: 'brand_microsoft', name: 'Microsoft', slug: 'microsoft', logo: 'https://images.unsplash.com/photo-1588872657578-7efd1f1555ed?auto=format&fit=crop&w=200&q=80', isActive: true, productCount: 3 },
  { id: 'brand_seagate', name: 'Seagate', slug: 'seagate', logo: 'https://images.unsplash.com/photo-1597872200969-2b65d56bd16b?auto=format&fit=crop&w=200&q=80', isActive: true, productCount: 4 },
...
export const SEED_PURCHASE_ORDERS: PurchaseOrder[] = [
  {
    ...
    items: [
      {
        ...
        sku: 'CPU-INT-14900K',
        title: 'Intel Core i9-14900K 24-Core 6.0GHz Raptor Lake Refresh',
        ...
        totalCost: 37000,
        subtotal: 37000,
        supplierName: 'Intel Middle East Authorized Distribution'
      },
      {
        productId: 'prod_xeon_platinum_8480',
        sku: 'CPU-INT-XEON-8480',
        title: 'Intel Xeon Platinum 8480+ Sapphire Rapids 56-Core Workstation',
        name: 'Intel Xeon Platinum 8480+ Sapphire Rapids 56-Core Workstation',
        currentStock: 4,
        lowStockThreshold: 2,
        suggestedReorderQuantity: 4,
        orderedQuantity: 4,
        quantity: 4,
        unitCost: 28500,
        totalCost: 114000,
    ...
    totalCost: 151000,
    currency: 'AED',
    targetWarehouse: 'Dubai Logistics Center - Bay 3',
    destinationLocation: 'Dubai Logistics Center - Bay 3',
    supplierName: 'Intel Middle East Authorized Distribution',
    notes: 'Q3 Enterprise server and workstation replenishment batch.',
    issuedAt: new Date(Date.now() - 86400000 * 14).toISOString(),
    receivedAt: new Date(Date.now() - 86400000 * 10).toISOString(),
  ...
  },
  {
    ...
    items: [
      {
        ...
        title: 'ASUS ROG Strix GeForce RTX 4090 24GB GDDR6X OC Edition',
        ...
        totalCost: 68000,
        subtotal: 68000,
        supplierName: 'NVIDIA GCC Master Distribution Hub'
      }
    ],
    totalUnits: 10,
    ...
    totalCost: 68000,
    currency: 'AED',
    targetWarehouse: 'Abu Dhabi Freezone Regional Fulfillment Hub',
    destinationLocation: 'Abu Dhabi Freezone Regional Fulfillment Hub',
    supplierName: 'NVIDIA GCC Master Distribution Hub',
    notes: 'High-density deep learning GPU allocation.',
  ...
  },
  {
    ...
    items: [
      {
        ...
        title: 'Corsair Dominator Titanium RGB 64GB (2x32GB) DDR5 6000MHz',
        ...
        totalCost: 25500,
        subtotal: 25500,
        supplierName: 'Corsair GCC Channel Distribution'
      }
    ],
    totalUnits: 30,
    ...
    totalCost: 25500,
    currency: 'AED',
    targetWarehouse: 'Dubai Logistics Center - Bay 1',
    destinationLocation: 'Dubai Logistics Center - Bay 1',
    supplierName: 'Corsair GCC Channel Distribution',
    notes: 'In-transit dispatch from JAFZA regional warehouse.',
  ...
  },
  {
    ...
    items: [
      {
        ...
        title: 'Samsung 990 PRO 4TB PCIe Gen4 NVMe M.2 2280 Internal SSD',
        ...
        totalCost: 27500,
        subtotal: 27500,
        supplierName: 'Samsung Electronics MENA Partner Fleet'
      }
    ],
    totalUnits: 25,
    ...
    totalCost: 27500,
    currency: 'AED',
    targetWarehouse: 'Dubai Silicon Oasis HQ Center',
    destinationLocation: 'Dubai Silicon Oasis HQ Center',
    supplierName: 'Samsung Electronics MENA Partner Fleet',
    notes: 'Draft low-stock reorder batch awaiting procurement sign-off.',
...
export const SEED_ORDERS: Order[] = [
  {
    ...
    items: [
      {
        ...
        sellerType: 'ADMIN',
        brandName: 'ASUS',
        categoryName: 'Graphics Cards (GPUs)',
      }
    ],
    subtotal: 16998,
    discount: 500,
    ...
    statusHistory: [
      { status: 'DELIVERED', timestamp: new Date(Date.now() - 86400000 * 8).toISOString() }
    ],
  ...
  },
  {
    ...
    statusHistory: [
      { status: 'PROCESSING', timestamp: new Date(Date.now() - 86400000 * 2).toISOString() }
    ],
  ...
  },
  {
    ...
    items: [
      {
        ...
        sellerType: 'ADMIN',
        brandName: 'Samsung',
        categoryName: 'Storage (NVMe/SSD/HDD)',
      }
    ],
    subtotal: 6995,
    discount: 0,
    ...
    statusHistory: [
      { status: 'CONFIRMED', timestamp: new Date(Date.now() - 86400000 * 1).toISOString() }
    ],
