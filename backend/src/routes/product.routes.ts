...
router.get("/brands", (req, res, next) =>
    productController.getBrands(req, res).catch(next),
);
router.get("/config", (req, res, next) =>
    productController.getStoreConfig(req, res).catch(next),
);
router.get("/:slug", (req, res, next) =>
    productController.getProductBySlug(req, res).catch(next),
);
