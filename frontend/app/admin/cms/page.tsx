...
export default function AdminCmsPage() {
  ...
  const confirmDeleteFeature = async () => {
    ...
    const { id, title } = deletingFeature;
                  ...
                  >
                    <div className="flex items-start justify-between gap-3">
                      ...
                      <div className="flex items-center gap-1.5">
                        ...
                        <button
                          onClick={() => setDeletingFeature({ id: feat.id, title: feat.title })}
        ...
        <div className="fixed inset-0 z-50 bg-slate-950/70 backdrop-blur-sm flex items-center justify-center p-4 animate-in fade-in duration-150">
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl max-w-md w-full p-6 space-y-4 shadow-2xl">
            <div className="flex items-center gap-3 text-red-600 dark:text-red-400">
              ...
              <div>
                <h3 className="text-sm font-black text-slate-900 dark:text-white">Delete Trust Bento Card</h3>
                <p className="text-[11px] text-slate-500">Homepage CMS Modification</p>
              </div>
            </div>

            <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
              Are you sure you want to remove <strong className="text-slate-900 dark:text-white">&quot;{deletingFeature.title}&quot;</strong>? This feature card will immediately disappear from the storefront homepage.
            </p>
            ...
            <div className="flex items-center justify-end gap-2.5 pt-3 border-t border-slate-100 dark:border-slate-800">
              ...
              <button
                ...
                className="px-5 py-2 rounded-xl bg-red-600 hover:bg-red-500 text-white text-xs font-bold shadow-md transition-all cursor-pointer disabled:opacity-50"
              >
